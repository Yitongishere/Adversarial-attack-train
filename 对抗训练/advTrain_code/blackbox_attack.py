        ...
        for epoch in range(num_epochs):
            ...
            if predict_black == target:
                ...
                if img_num < 10:
                    ...
                    plt.savefig("../advTrain_blackbox_samples/sample{}.png".format(img_num))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--attack_data_path', type=str, default='../advTrain_attack_data/adv_model_correct_1k.pkl')
    parser.add_argument('--weights_save_path_extra_model', type=str, default='../advTrain_model/Extra_Model_ep_20_devacc_91.43_.pt')
    parser.add_argument('--weights_save_path_black', type=str, default='../advTrain_model/Adversarial_train_ep_20_devacc_92.4_.pt')
    ...
    # load my own model
    my_model = extraCNN().to(device)
    # load trained weights
    my_model.load_state_dict(torch.load(opt.weights_save_path_extra_model, device_type))
