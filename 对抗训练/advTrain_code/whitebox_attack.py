...
def generating_adversarial_samples(num_samples, num_epochs, imgs, labels, \
    ...
    for sample in range(num_samples):
        ...
        for epoch in range(num_epochs):
            ...
            if predict == target:
                ...
                if img_num < 10:
                    ...
                    plt.savefig("../advTrain_whitekbox_samples/sample{}.png".format(img_num))
        ...
        print("Accumulate success num of whitebox attack: {} / {}".format(num_success, num_samples))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weights_save_path', type=str, default='../advTrain_model/Adversarial_train_ep_20_devacc_92.4_.pt')
