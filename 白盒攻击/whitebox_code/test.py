...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='../whitebox_model/White_ep_20_devacc_91.72_.pt')
    parser.add_argument('--dataset_dir', type=str, default='../../data')
    parser.add_argument('--eval_batch_size', type=int, default=1000)
    parser.add_argument('--rand_seed', type=int, default=42)
    parser.add_argument('--gen_data_path', type=str, default='../whitebox_attack_data/white_adversarial_correct_1k.pkl')
